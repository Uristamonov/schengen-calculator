...
export default function GraphicalTimeline({
  ...
  // Core drag handling translation calculations
  ...
  useEffect(() => {
    const handleMouseGlobalMove = (e) => {
      ...
      // Strictly trap boundaries within our 18-month lookahead span
  ...
  return (
    <>
      ...
      >
        ...
        {/* 🎛️ DRAGGABLE 180-DAY ROLLING WINDOW BOUNDARY */}
        <div 
        ...
        {/* Evaluation line pinpoint markers */}
